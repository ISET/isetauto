function [objectPosition_list] = iaObjectRandomPlan(sidewalk_list,object_list, object_number, offset)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for jj = 1 : numel(sidewalk_list)
    ...
    for ii = 1 : object_number
        ...
        count = count + 1;
        objectPosition_list(count).name     = object_list(rand_num).name;
        objectPosition_list(count).size     = object_list(rand_num).size;
