function trafficflow=iaParkingPlace(sceneInfo, trafficflow, varargin)
% Add parked cars in trafficflow
%
% Inputs
%  sceneInfo: road information
%
...
parking_list=sceneInfo.roadinfo.parking_list;
