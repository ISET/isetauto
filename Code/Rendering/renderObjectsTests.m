...
truckFile = sprintf('Truck_%i.obj',carId);
parentSceneFile = fullfile(assetDir,truck2directory{carId},truckFile);

% carId = 1;
% truckFile = sprintf('Bus_%i.obj',carId);
% parentSceneFile = fullfile(assetDir,bus2directory{carId},truckFile);
