...
title('Vehicle Speed & Distance to Pedestrian over Time', ...
    ['Start -- Speed:',num2str(scenario.initialSpeed(),1),', Distance: ',num2str(targetDistance(1),1), ...
     ', Threshold: ', num2str(scenario.predictionThreshold,2), ', Sensor: ',scenario.sensorModel], ... 
     'FontSize',14);
